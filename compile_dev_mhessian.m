...
OBSERVATION_MODEL = {fullfile(COMPUTATION_LOCATION,'model.c'), ...
                     fullfile(MODEL_LOCATION,'plain_SV.c'), ...
...
% % Compile mex files
% mex(MEXOPTS{:}, 'fct/state_post_draw.c', OBSERVATION_MODEL{:}, ALPHA_UNIVARIATE{:})
% mex(MEXOPTS{:}, 'fct/state_post_eval.c', OBSERVATION_MODEL{:}, ALPHA_UNIVARIATE{:})
% mex(MEXOPTS{:}, 'fct/state_prior_draw.c', ALPHA_UNIVARIATE{:})
% mex(MEXOPTS{:}, 'fct/state_prior_eval.c', ALPHA_UNIVARIATE{:})
% mex(MEXOPTS{:}, 'fct/obs_draw.c', OBSERVATION_MODEL{:}, OBSERVATION_DRAW{:})
% mex(MEXOPTS{:}, 'fct/obs_eval.c', OBSERVATION_MODEL{:}, OBSERVATION_DRAW{:})
