// This code is copyright Mark Joshi, modified by William McCausland.
// See copyright notice at end of file.

#include <math.h>
#include "Phi.h"

// The inverse normal cumulative distribution function via the
// Beasley-Springer/Moro approximation.

const double OneOverRootTwoPi = 0.398942280401433;

// Probability density function for a standard Gaussian distribution
double phi(double x)
{
    return OneOverRootTwoPi*exp(-x*x/2);
}

double inverse_Phi(double u)
{
